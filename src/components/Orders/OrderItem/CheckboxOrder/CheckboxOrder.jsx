...
export const CheckboxOrder = () => {
  return (
    <div className="checkbox-order">
      <div className="checkbox-order__item active">
        <input type="checkbox-order" className="checkbox-order__input" id="fuel" />
        <label htmlFor="fuel" className="checkbox-order__label">
          <img src={fuel} alt="" width="14px" height="14px" />
          <span>Полный бак</span>
        </label>
      </div>
      <div className="checkbox-order__item">
        <input type="checkbox-order" className="checkbox-order__input" id="chair" />
      ...
      <div className="checkbox-order__item">
        <input type="checkbox-order" className="checkbox-order__input" id="wheel" />
